...
class RSContentPresentationVC: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func activateGalleryConstriants() {
        ...
        NSLayoutConstraint.activate([
            ...
            imageGalleryCollection.heightAnchor.constraint(equalToConstant: galleryCollectionHeight),
            contentView.bottomAnchor.constraint(equalTo: imageGalleryCollection.bottomAnchor),
        ])
    }
